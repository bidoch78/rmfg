...
#define TFT_MOSI  PIN_D11  // Automatically assigned with ESP8266 if not defined
#define TFT_SCLK  PIN_D13  // Automatically assigned with ESP8266 if not defined

#define TFT_CS    PIN_D10  // Chip select control pin D8
